var storeModule = {
    ...
    uris: {
        getUri: 'http://localhost:5001/api/v1.0/stores/owner',
        createUri: 'http://localhost:5001/api/v1.0/stores',
        deleteSelectedUri: 'http://localhost:5001/api/v1.0/stores/entities',
        updateUri: 'http://localhost:5001/api/v1.0/stores'
    },
